...
command! -nargs=1 DockerPush lua require("docker").push(<q-args>)
command! -nargs=1 DockerPull lua require("docker").pull(<q-args>)
command! -nargs=1 DockerLogs lua require("docker").logs(<q-args>)
